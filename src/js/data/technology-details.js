// Generated from https://paldb.cc/cn/hover. Run `npm run fetch:technology-details` to refresh.
export const TECHNOLOGY_DETAILS = {
  "Workbench": {
    "description": "用来制作简单道具的「原始的作业台」。\n如有具备「手工作业」适应性的帕鲁，\n它就会前来协助。",
    "unlocks": [
      {
        "name": "原始的作业台",
  ...
  "Infra_ItemChest_Grade_01": {
    "description": "可用于收纳道具。将之设置在据点后，\n具备「搬运」适应性的帕鲁便会自动搬运道具。",
    "unlocks": [
      {
        "name": "木箱",
  ...
  "Infra_PalBed_Grade_01": {
    "description": "据点里的帕鲁晚上若能睡在帕鲁床上，便可恢复SAN值。\n没有帕鲁床的话会因睡不舒服而无法恢复SAN值。",
    "unlocks": [
      {
        "name": "稻草帕鲁床",
  ...
  "Product_Farm_Berries": {
    "description": "能够生产野莓的农园。\n需要有具备「播种」、「浇水」和「采集」适应性的帕鲁才能进行作业。",
    "unlocks": [
      {
        "name": "野莓农园",
  ...
  "FurnitureSet_1": {
    "description": "装饰用的家具套组。\n放在客厅，尽情享受和帕鲁一起的快乐生活吧。",
    "unlocks": [
      {
        "name": "方桌",
  ...
  "SkillUnlock_Boar": {
    ...
    "unlocks": [
      {
        "name": "草莽猪的鞍具",
        "image": "https://cdn.paldb.cc/image/Others/InventoryItemIcon/Texture/T_itemicon_Essential_SkillUnlock_Saddle.webp",
        "description": "持有此道具时，\n即可骑乘草莽猪。",
        "materials": [
          {
  ...
  "SkillUnlock_Kitsunebi": {
    "description": "用来抱住火绒狐的背带。\n发动伙伴技能后，即可将火绒狐\n抱在身上当作火焰喷射器进行攻击。",
    "unlocks": [
      {
        "name": "火绒狐的背带",
        "image": "https://cdn.paldb.cc/image/Others/InventoryItemIcon/Texture/T_itemicon_Essential_SkillUnlock_Harness.webp",
        "description": "用来抱住火绒狐的背带。\n发动伙伴技能后，即可将火绒狐\n抱在身上当作火焰喷射器进行攻击。",
        "materials": [
          {
            "image": "https://cdn.paldb.cc/image/Others/InventoryItemIcon/Texture/T_itemicon_Material_Leather.webp",
  ...
  "Product_StationDeforest": {
    "description": "可在据点内生产木材。\n需要有具备「伐木」适应性的帕鲁才能进行作业。",
    "unlocks": [
      {
        "name": "伐木场",
  ...
  "Product_StonePit": {
    "description": "可在据点内生产石材。\n需要有具备「采矿」适应性的帕鲁才能进行作业。",
    "unlocks": [
      {
        "name": "采石场",
  ...
  "Product_Factory_Hard_Grade_01": {
    "description": "生产速度比「原始的作业台」更快。\n需要有具备「手工作业」适应性的帕鲁才能进行作业。",
    "unlocks": [
      {
        "name": "优质作业台",
  ...
  "SkillUnlock_Carbunclo": {
    "description": "翠叶鼠专用的小型冲锋枪。\n发动伙伴技能后，它会坐在玩家的头上，\n配合玩家的攻击进行额外射击。",
    "unlocks": [
      {
        "name": "翠叶鼠的冲锋枪",
        "image": "https://cdn.paldb.cc/image/Others/InventoryItemIcon/Texture/T_itemicon_Essential_SkillUnlock_SMG.webp",
        "description": "翠叶鼠专用的小型冲锋枪。\n发动伙伴技能后，它会坐在玩家的头上，\n配合玩家的攻击进行额外射击。",
        "materials": [
          {
            "image": "https://cdn.paldb.cc/image/Others/InventoryItemIcon/Texture/T_itemicon_Material_CopperIngot.webp",
  ...
  "Product_Medicine_Grade_01": {
    "description": "可制作简单的药物。\n需要有具备「制药」适应性的帕鲁才能进行作业。",
    "unlocks": [
      {
        "name": "中世纪制药台",
  ...
  "SkillUnlock_Monkey": {
    "description": "新叶猿专用的小型突击步枪。\n发动伙伴技能后，新叶猿会进入射击模式，\n猛烈扫射周围的敌人。",
    "unlocks": [
      {
        "name": "新叶猿的突击步枪",
        "image": "https://cdn.paldb.cc/image/Others/InventoryItemIcon/Texture/T_itemicon_Essential_SkillUnlock_AssaultRifle.webp",
        "description": "新叶猿专用的小型突击步枪。\n发动伙伴技能后，新叶猿会进入射击模式，\n猛烈扫射周围的敌人。",
        "materials": [
          {
            "image": "https://cdn.paldb.cc/image/Others/InventoryItemIcon/Texture/T_itemicon_Material_CopperIngot.webp",
    ...
    "unlocks": [
      {
        ...
        "materials": [
          ...
          {
            "image": "https://cdn.paldb.cc/image/Others/InventoryItemIcon/Texture/T_itemicon_Material_Horn.webp",
            "name": "角",
            "amount": "3"
          },
          {
  ...
  "SkillUnlock_Monkey_Fire": {
    "description": "秋叶猿专用的小型突击步枪。\n发动伙伴技能后，秋叶猿会进入射击模式，猛烈扫射周围的敌人。",
    "unlocks": [
      {
        "name": "秋叶猿的突击步枪",
        "image": "https://cdn.paldb.cc/image/Others/InventoryItemIcon/Texture/T_itemicon_Essential_SkillUnlock_AssaultRifle.webp",
  ...
  "FishingSet1": {
    ...
    "unlocks": [
      ...
      {
        "name": "简陋钓饵",
        "image": "https://cdn.paldb.cc/image/Others/InventoryItemIcon/Texture/T_itemicon_Consume_FishingBait_1.webp",
        "description": "用来吸引帕鲁上钩的简单钓饵。\n垂钓必备。",
        "materials": [
          {
            "image": "https://cdn.paldb.cc/image/Others/InventoryItemIcon/Texture/T_itemicon_Material_PalFluid.webp",
            "name": "水栖帕鲁的黏液",
          ...
          {
            "image": "https://cdn.paldb.cc/image/Others/InventoryItemIcon/Texture/T_itemicon_Material_Flour.webp",
            "name": "面粉",
            "amount": "2"
          }
        ]
    ...
    "unlocks": [
      {
        ...
        "description": "可制作各式菜肴的基础食材。\n小麦正是最基础的农作物。",
        "materials": []
      }
    ]
  },
  "Processed_Wood": {
    "description": "为了易于使用，切割原木得到的板材。\n泛用性比整根原木更高，应用范围更广。\n可在「原始的作业台」制作。",
    "unlocks": [
      {
        "name": "木板",
  ...
  "FurnitureTree_Yellow": {
    "description": "装饰用的黄叶树模型套组。\n配置一些树木，打造自然风格的据点吧。\n拆除此建筑物无法取得材料。",
    "unlocks": [
      {
        "name": "仿真黄叶树A",
  ...
  "SkillUnlock_Penguin": {
    "description": "用来发射企丸丸的炮筒。\n发动伙伴技能后，即可将企丸丸射出\n对敌人进行攻击。随后，企丸丸会进入濒死状态。",
    "unlocks": [
      {
        "name": "企丸丸的火箭发射器",
        "image": "https://cdn.paldb.cc/image/Others/InventoryItemIcon/Texture/T_itemicon_Essential_SkillUnlock_Launcher.webp",
        "description": "用来发射企丸丸的炮筒。\n发动伙伴技能后，即可将企丸丸射出\n对敌人进行攻击。随后，企丸丸会进入濒死状态。",
        "materials": [
          {
            "image": "https://cdn.paldb.cc/image/Others/InventoryItemIcon/Texture/T_itemicon_Material_CopperIngot.webp",
  ...
  "SkillUnlock_ColorfulBird": {
    "description": "用来轻轻抓住炸蛋鸟的手套。\n发动伙伴技能后，即可抱着炸蛋鸟，\n发射爆炸蛋来进行攻击。",
    "unlocks": [
      {
        "name": "炸蛋鸟的手套",
        "image": "https://cdn.paldb.cc/image/Others/InventoryItemIcon/Texture/T_itemicon_Essential_SkillUnlock_Gloves.webp",
        "description": "用来轻轻抓住炸蛋鸟的手套。\n发动伙伴技能后，即可抱着炸蛋鸟，\n发射爆炸蛋来进行攻击。",
        "materials": [
          {
            "image": "https://cdn.paldb.cc/image/Others/InventoryItemIcon/Texture/T_itemicon_Material_Cloth.webp",
  ...
  "SkillUnlock_Penguin_Electric": {
    "description": "用来发射闪丸丸的炮筒。\n发动伙伴技能后，即可将闪丸丸射出，\n对敌人进行攻击。随后，闪丸丸会进入濒死状态。",
    "unlocks": [
      {
        "name": "闪丸丸的火箭发射器",
        "image": "https://cdn.paldb.cc/image/Others/InventoryItemIcon/Texture/T_itemicon_Essential_SkillUnlock_Launcher.webp",
  ...
  "Accessory_Nonkilling": {
    "description": "和平主义者的戒指。\n装备该戒指者无法将攻击对象的生命值降低到1以下。",
    "unlocks": [
      {
        "name": "慈悲戒指",
    ...
    "unlocks": [
      {
        ...
        "materials": [
          ...
          {
            "image": "https://cdn.paldb.cc/image/Others/InventoryItemIcon/Texture/T_itemicon_Material_Bone.webp",
            "name": "骨头",
            "amount": "1"
          },
          {
    ...
    "unlocks": [
      {
        ...
        "materials": [
          ...
          {
            "image": "https://cdn.paldb.cc/image/Others/InventoryItemIcon/Texture/T_itemicon_Food_Milk.webp",
            "name": "牛奶",
            "amount": "7"
          },
          {
            "image": "https://cdn.paldb.cc/image/Others/InventoryItemIcon/Texture/T_itemicon_Food_Egg.webp",
            "name": "蛋",
            "amount": "8"
          },
          {
            "image": "https://cdn.paldb.cc/image/Others/InventoryItemIcon/Texture/T_itemicon_Food_Honey.webp",
            "name": "蜂蜜",
            "amount": "2"
          }
        ]
    ...
    "unlocks": [
      {
        ...
        "materials": [
          ...
          {
            "image": "https://cdn.paldb.cc/image/Others/InventoryItemIcon/Texture/T_itemicon_Food_Tomato.webp",
            "name": "番茄",
            "amount": "4"
          },
          {
    ...
    "unlocks": [
      {
        ...
        "materials": [
          {
            "image": "https://cdn.paldb.cc/image/Others/InventoryItemIcon/Texture/T_itemicon_Material_PalItem_RaijinDaughter.webp",
            "name": "雷鸣童子的云朵",
            "amount": "1"
          },
          {
  ...
  "FurnitureTree_Bamboo": {
    "description": "装饰用的竹子模型套组。\n配置一些竹子，打造竹林风格的据点吧。\n拆除此建筑物无法取得材料。",
    "unlocks": [
      {
        "name": "仿真竹子A",
  ...
  "FragGrenade": {
    "description": "可在中距离战斗时发挥作用的破片手榴弹。\n投掷数秒后引爆，给敌人造成伤害。",
    "unlocks": [
      {
        "name": "破片手榴弹",
  ...
  "Battle_Defense_BowGun": {
    "description": "将具备「手工作业」适应性的帕鲁分派到这里，\n它就会操控十字弓坚守据点。",
    "unlocks": [
      {
        "name": "固定式十字弓",
  ...
  "FurnitureTree_Tropical": {
    "description": "装饰用的热带树木模型套组。\n配置一些树木，打造南国风格的据点吧。\n拆除此建筑物无法取得材料。",
    "unlocks": [
      {
        "name": "仿真热带树木A",
    ...
    "unlocks": [
      {
        ...
        "materials": [
          ...
          {
            "image": "https://cdn.paldb.cc/image/Others/InventoryItemIcon/Texture/T_itemicon_Material_NightStone.webp",
            "name": "夜星砂",
            "amount": "10"
          }
        ]
  ...
  "Product_Factory_Hard_Grade_02": {
    "description": "虽需使用电力，但生产各种道具的速度较为快速。\n需要有具备「手工作业」适应性的帕鲁才能进行作业。",
    "unlocks": [
      {
        "name": "作业流水线工厂",
    ...
    "unlocks": [
      {
        ...
        "description": "适应性强、饱腹感好的优质作物。\n不适合生食。",
        "materials": []
      }
    ]
  },
  "FragGrenade_Ice": {
    "description": "利于中等距离战斗的冷冻手榴弹。\n投掷数秒后引爆，冻结周围一切。",
    "unlocks": [
      {
        "name": "冷冻手榴弹",
  ...
  "Metal_houseset": {
    "description": "解锁此套组即可用金属建筑建造据点。\n可以建造金属制的地基、墙壁、屋顶和楼梯等\n建造房屋时所需的构造。",
    "unlocks": [
      {
        "name": "金属地基",
  ...
  "Bio_Coolant": {
    "description": "用帕鲁身上提取的特殊成分制作的高效冷却介质。\n用于控制大功率设备的温度。\n可在「作业流水线工厂」制作。",
    "unlocks": [
      {
        "name": "极低温冷却介质",
  ...
  "Spa2": {
    "description": "进入此设施的帕鲁能够恢复更多SAN值。",
    "unlocks": [
      {
        "name": "优质温泉",
  ...
  "Product_WeaponFactory_Dirty_Grade_02": {
    "description": "虽需使用电力，但生产武器及弹药的速度较为快速。\n需要有具备「手工作业」适应性的帕鲁才能进行作业。",
    "unlocks": [
      {
        "name": "武器流水线工厂",
  ...
  "SkillUnlock_GrassPanda": {
    "description": "持有此道具时，\n即可骑乘叶胖达，并用榴弹发射器进行猛烈射击。",
    "unlocks": [
      {
        "name": "叶胖达的榴弹发射器",
        "image": "https://cdn.paldb.cc/image/Others/InventoryItemIcon/Texture/T_itemicon_Essential_SkillUnlock_Grenadelauncher.webp",
        "description": "持有此道具时，\n即可骑乘叶胖达，并用榴弹发射器进行猛烈射击。",
        "materials": [
          {
            "image": "https://cdn.paldb.cc/image/Others/InventoryItemIcon/Texture/T_itemicon_Material_CopperIngot.webp",
  ...
  "OctaviaSet01": {
    ...
    "unlocks": [
      ...
      {
        "name": "神射左轮手枪",
        "image": "https://cdn.paldb.cc/image/Others/InventoryItemIcon/Texture/T_itemicon_Weapon_OctaviaRevolver.webp",
        "description": "【ULTRAKILL 联动】\n利用电能驱动可连续射击的左轮手枪。\n装备期间，投掷捕获用帕鲁球的动作会变为掷硬币，\n神射左轮手枪的子弹击中硬币时将会弹向敌人。",
        "materials": [
          {
            "image": "https://cdn.paldb.cc/image/Others/InventoryItemIcon/Texture/T_itemicon_Material_CopperIngot.webp",
            "name": "金属锭",
          ...
          {
            "image": "https://cdn.paldb.cc/image/Others/InventoryItemIcon/Texture/T_itemicon_Material_Money.webp",
            "name": "金币",
            "amount": "1"
          },
          {
  ...
  "Battle_RangeWeapon_OldRevolver": {
    "description": "略显陈旧的左轮手枪。\n单发威力优于手枪。",
    "unlocks": [
      {
        "name": "古旧左轮手枪",
  ...
  "Product_Ingot_Grade_02_Iron": {
    "description": "可冶炼「精炼金属锭」。",
    "unlocks": [
      {
        "name": "改善后的炉子",
        "image": "https://cdn.paldb.cc/image/Pal/Texture/BuildObject/PNG/T_icon_buildObject_BlastFurnace_2.webp",
        "description": "用于制作优质金属武器及防具的素材。\n将金属矿石与石炭放入炉中即可制作。",
        "materials": [
          {
            "image": "https://cdn.paldb.cc/image/Others/InventoryItemIcon/Texture/T_itemicon_Material_CopperOre.webp",
            "name": "金属矿石",
            "amount": "2"
          },
          {
  ...
  "Product_Axe_Grade_03": {
    "description": "能砍伐生长于火山、沙漠等严苛环境中的坚韧树木，取得硬木材的斧子。。\n可在「作业流水线工厂」制作。",
    "unlocks": [
      {
        "name": "精炼金属斧头",
        "image": "https://cdn.paldb.cc/image/Others/InventoryItemIcon/Texture/T_itemicon_Weapon_Axe_Tier_00.webp",
        "description": "精挑细选的优质木材。\n砍伐生长在沙漠、火山、雪山等\n极端环境下的树木可以获得。",
        "materials": []
      }
    ]
  },
  ...
  "Infra_ElectronicCircuit": {
    "description": "制作精密机械时会用到的「电路板」。\n可在「作业流水线工厂」制作。",
    "unlocks": [
      {
        "name": "电路板",
        "image": "https://cdn.paldb.cc/image/Others/InventoryItemIcon/Texture/T_itemicon_Material_ElectronicCircuit.webp",
        "description": "制作精密机器时必不可少的电路板。\n可在作业流水线工厂制作。",
        "materials": [
          {
    ...
    "unlocks": [
      {
        ...
        "description": "自古深受喜爱的易种植作物。\n不适合生食。",
        "materials": []
      }
    ]
  },
  "Cloth2": {
    "description": "编织大量「羊毛」制成的「优质的布」。\n是制作优质防具时必不可少的素材。\n可在「优质作业台」制作。",
    "unlocks": [
      {
        "name": "优质的布",
        "image": "https://cdn.paldb.cc/image/Others/InventoryItemIcon/Texture/T_itemicon_Material_Cloth.webp",
  ...
  "Special_ElectricHatchingPalEgg": {
    "description": "用于孵化帕鲁蛋的装置。\n需要电力供应才能运作，\n但可自动将该孵化器的内部保持在最佳温度。",
    "unlocks": [
      {
        "name": "电能帕鲁蛋孵化器",
  ...
  "Battle_RangeWeapon_SubmachineGun": {
    "description": "连射能力优异的冲锋枪。\n轻巧灵活，适合近距离战斗。",
    "unlocks": [
      {
        "name": "冲锋枪",
  ...
  "FurnitureTree_Desert": {
    "description": "装饰用的沙漠树木模型套组。\n配置一些树木，打造沙漠风格的据点吧。\n拆除此建筑物无法取得材料。",
    "unlocks": [
      {
        "name": "仿真沙漠树木A",
  ...
  "Launcher_Meteor": {
    ...
    "unlocks": [
      ...
      {
        "name": "陨石弹",
        "image": "https://cdn.paldb.cc/image/Others/InventoryItemIcon/Texture/T_itemicon_Ammo_MeteorBullet.webp",
        "description": "陨石发射器等使用的弹药。\n可在「武器流水线工厂」制作。",
        "materials": [
          {
            "image": "https://cdn.paldb.cc/image/Others/InventoryItemIcon/Texture/T_itemicon_Material_MeteorDrop.webp",
            "name": "陨石碎片",
            "amount": "3"
          }
        ]
    ...
    "unlocks": [
      {
        ...
        "materials": [
          ...
          {
            "image": "https://cdn.paldb.cc/image/Others/InventoryItemIcon/Texture/T_itemicon_Food_Onion.webp",
            "name": "洋葱",
            "amount": "4"
          },
          {
            "image": "https://cdn.paldb.cc/image/Others/InventoryItemIcon/Texture/T_itemicon_Food_Carrot.webp",
            "name": "胡萝卜",
            "amount": "3"
          },
          {
  ...
  "Battle_RangeWeapon_ShotGun": {
    "description": "近距离战斗能力强劲的霰弹枪，可以连射2发。\n弹容量虽少，但火力很强。\n可在「武器流水线工厂」制作。",
    "unlocks": [
      {
        "name": "双管霰弹枪",
  ...
  "Infra_ItemChest_Grade_03": {
    "description": "可进一步收纳更多道具，耐久度也有所提升。\n具备「搬运」适应性的帕鲁会自动搬运道具。",
    "unlocks": [
      {
        "name": "精炼金属箱",
    ...
    "unlocks": [
      {
        ...
        "materials": [
          ...
          {
            "image": "https://cdn.paldb.cc/image/Others/InventoryItemIcon/Texture/T_itemicon_Food_Mushroom.webp",
            "name": "蘑菇",
            "amount": "20"
          },
          {
    ...
    "unlocks": [
      {
        ...
        "materials": [
          ...
          {
            "image": "https://cdn.paldb.cc/image/Others/InventoryItemIcon/Texture/T_itemicon_Food_PoisonMushroom.webp",
            "name": "不可思议的蘑菇",
            "amount": "20"
          },
          {
  ...
  "SkillUnlock_ElecPanda": {
    "description": "持有此道具时，即可骑乘暴电熊，\n并用机关枪进行猛烈射击。",
    "unlocks": [
      {
        "name": "暴电熊的机关枪",
        "image": "https://cdn.paldb.cc/image/Others/InventoryItemIcon/Texture/T_itemicon_Essential_SkillUnlock_Minigun.webp",
        "description": "持有此道具时，即可骑乘暴电熊，\n并用机关枪进行猛烈射击。",
        "materials": [
          {
            "image": "https://cdn.paldb.cc/image/Others/InventoryItemIcon/Texture/T_itemicon_Material_IronIngot.webp",
  ...
  "Battle_RangeWeapon_SemiAutoRifle": {
    "description": "具备一定连射能力的步枪。\n易于瞄准且火力强大，适合中距离战斗。",
    "unlocks": [
      {
        "name": "半自动步枪",
  ...
  "Product_Cooking_Grade_03": {
    "description": "虽需使用电力，但可应对更复杂、更有效率的烹饪需求。\n需要有具备「生火」适应性的帕鲁才能进行作业。",
    "unlocks": [
      {
        "name": "电气厨房",
  ...
  "ElectricHeater": {
    "description": "使用电力，效果更强的暖炉，范围广且输出功率高。",
    "unlocks": [
      {
        "name": "电气取暖器",
  ...
  "Battle_RangeWeapon_CompoundBow": {
    "description": "经过现代化改良的弓。\n能够射出威力更强大的箭矢。",
    "unlocks": [
      {
        "name": "复合弓",
  ...
  "Product_Factory_Hard_Grade_03": {
    "description": "虽需使用电力，但生产各种道具的速度更为快速。\n需要有具备「手工作业」适应性的帕鲁才能进行作业。",
    "unlocks": [
      {
        "name": "作业流水线工厂 II",
  ...
  "ElectricCooler": {
    "description": "使用电力，效果更强的冷气，范围广且输出功率高。",
    "unlocks": [
      {
        "name": "电气降温器",
  ...
  "HighGrade_Processed_Wood": {
    "description": "精心切割硬木材得到的板材。\n拥有美丽的木纹，在建筑中常用于营造高端奢华的感觉。\n可在「作业流水线工厂 II」制作。",
    "unlocks": [
      {
        "name": "优质木板",
  ...
  "Glass_houseset": {
    "description": "解锁此套组即可用玻璃建筑建造据点。\n可以建造玻璃制的地基、墙壁、屋顶和楼梯等\n建造房屋时所需的构造。",
    "unlocks": [
      {
        "name": "玻璃地基",
  ...
  "Battle_RangeWeapon_AssaultRifle": {
    "description": "以压倒性的连射能力镇压敌人的突击步枪。\n火力优秀，是与强敌对战时的首选。\n可在「武器流水线工厂」制作。",
    "unlocks": [
      {
        "name": "突击步枪",
  ...
  "SkillUnlock_LazyDragon": {
    "description": "持有此道具时，即可骑乘佩克龙，\n并用导弹发射器进行猛烈射击。",
    "unlocks": [
      {
        "name": "佩克龙的导弹发射器",
        "image": "https://cdn.paldb.cc/image/Others/InventoryItemIcon/Texture/T_itemicon_Essential_SkillUnlock_MultiMissile.webp",
        "description": "持有此道具时，即可骑乘佩克龙，\n并用导弹发射器进行猛烈射击。",
        "materials": [
          {
            "image": "https://cdn.paldb.cc/image/Others/InventoryItemIcon/Texture/T_itemicon_Material_IronIngot.webp",
  ...
  "DecalGunSet": {
    "description": "印花枪套组。\n解锁此套组，即可制作能在命中处留下帕鲁图案\n的奇妙枪支与其专用子弹。",
    "unlocks": [
      {
        "name": "印花枪1",
        "image": "https://cdn.paldb.cc/image/Others/InventoryItemIcon/Texture/T_itemicon_Weapon_DecalGun.webp",
        "description": "能在命中处留下捣蛋猫图案的奇妙枪支。\n享受在墙壁及地板上作画的乐趣吧。",
        "materials": [
          {
            "image": "https://cdn.paldb.cc/image/Others/InventoryItemIcon/Texture/T_itemicon_Material_CopperIngot.webp",
            "name": "金属锭",
      ...
      },
      {
        "name": "印花枪4",
        "image": "https://cdn.paldb.cc/image/Others/InventoryItemIcon/Texture/T_itemicon_Weapon_DecalGun.webp",
        "description": "能在命中处留下阿努比斯图案的奇妙枪支。\n享受在墙壁及地板上作画的乐趣吧。",
        "materials": [
          {
            "image": "https://cdn.paldb.cc/image/Others/InventoryItemIcon/Texture/T_itemicon_Material_CopperIngot.webp",
            "name": "金属锭",
    ...
    "unlocks": [
      {
        ...
        "description": "可在火山等地找到的硫磺。\n是制作火药时必须用到的素材。",
        "materials": []
      }
    ]
  },
  "Battle_RangeWeapon_SemiAutoShotgun": {
    "description": "连射能力优异的霰弹枪。\n拥有首屈一指的近距离DPS能力。",
    "unlocks": [
      {
        "name": "半自动霰弹枪",
  ...
  "Product_WeaponFactory_Dirty_Grade_03": {
    "description": "虽需使用电力，但生产武器及弹药的速度更为快速。\n需要有具备「手工作业」适应性的帕鲁才能进行作业。",
    "unlocks": [
      {
        "name": "武器流水线工厂II",
  ...
  "JapaneseStyle_houseset": {
    "description": "解锁此套组即可用和风建筑建造据点。\n可以建造的有地基、墙壁、屋顶和楼梯等\n建造房屋时所需的构造。",
    "unlocks": [
      {
        "name": "和风墙壁",
    ...
    "unlocks": [
      {
        ...
        "description": "能够加工成各种制品的素材。\n可通过在油田设置原油提炼机来获得。",
        "materials": []
      }
    ]
  },
  "Plastic": {
    "description": "由原油和金属加工制成的素材。\n可在电气炉制作。",
    "unlocks": [
      {
        "name": "塑钢",
  ...
  "Battle_Defense_Missile": {
    "description": "将具备「手工作业」适应性的帕鲁分派到这裡，\n它就会操控飞弹发射器坚守据点。",
    "unlocks": [
      {
        "name": "固定式导弹发射器",
  ...
  "Battle_Armor_Grade_05_Plastic": {
    "description": "以塑钢制成的盔甲。\n在增强防御力的同时，实现了轻量化。\n可在「作业流水线工厂 II」制作。",
    "unlocks": [
      {
        "name": "塑钢盔甲",
        ...
        "materials": [
          {
            "image": "https://cdn.paldb.cc/image/Others/InventoryItemIcon/Texture/T_itemicon_Material_CrudeOil.webp",
            "name": "原油",
            "amount": "2"
          },
          {
  ...
  "Battle_Helm_Grade_06_Plastic": {
    "description": "以塑钢制成的头盔。\n在增强防御力的同时，实现了轻量化。\n可在「作业流水线工厂 II」制作。",
    "unlocks": [
      {
        "name": "塑钢头盔",
  ...
  "Battle_RangeWeapon_LaserRifle": {
    "description": "能够发射激光的武器。\n威力高又易于使用。\n可在「武器流水线工厂II」制作。",
    "unlocks": [
      {
        "name": "激光步枪",
  ...
  "Battle_Glider_Grade_04": {
    "description": "展开后可在空中滑翔的滑翔伞。\n性能得到进一步提升，速度和升力都提高了。\n可在「作业流水线工厂 II」制作。",
    "unlocks": [
      {
        "name": "特级滑翔伞",
  ...
  "Battle_RangeWeapon_FlameThrower": {
    "description": "能够向远处喷出火舌的火焰喷射器。\n可以使攻击目标陷入点燃状态。\n可在「武器流水线工厂II」制作。",
    "unlocks": [
      {
        "name": "火焰喷射器",
    ...
    "unlocks": [
      {
        ...
        "materials": [
          ...
          {
            "image": "https://cdn.paldb.cc/image/Others/InventoryItemIcon/Texture/T_itemicon_Food_HealingMushroom.webp",
            "name": "洞穴蘑菇",
            "amount": "1"
          },
          {
  ...
  "SkillUnlock_BadCatgirl": {
    "description": "妮瞅莎专用的霰弹枪。\n发动伙伴技能后，妮瞅莎会进入射击模式，\n猛烈攻击周围的敌人。",
    "unlocks": [
      {
        "name": "妮瞅莎的霰弹枪",
        "image": "https://cdn.paldb.cc/image/Others/InventoryItemIcon/Texture/T_itemicon_Essential_SkillUnlock_Shotgun.webp",
        "description": "妮瞅莎专用的霰弹枪。\n发动伙伴技能后，妮瞅莎会进入射击模式，\n猛烈攻击周围的敌人。",
        "materials": [
          {
            "image": "https://cdn.paldb.cc/image/Others/InventoryItemIcon/Texture/T_itemicon_Material_IronIngot.webp",
          ...
          {
            "image": "https://cdn.paldb.cc/image/Others/InventoryItemIcon/Texture/T_itemicon_Material_PalDarkParts.webp",
            "name": "暗黑碎片",
            "amount": "30"
          },
          {
    ...
    "unlocks": [
      {
        ...
        "description": "可在雪山等地找到的纯水晶。\n是制作电路板时必须用到的素材。",
        "materials": []
      }
    ]
  },
  "AdditionalInventory_003": {
    "description": "能够额外携带物品的大背包。\n持有此道具时，可增加背包栏位。\n只需携带一个就足够了。",
    "unlocks": [
      {
        "name": "大型扩展背包",
  ...
  "Battle_RangeWeapon_GrenadeLauncher": {
    "description": "能够发射造成大范围爆炸的榴弹。\n对付大群敌人时很有用。\n可在「武器流水线工厂II」制作。",
    "unlocks": [
      {
        "name": "榴弹发射器",
  ...
  "Battle_Armor_Grade_05_Plastic_Cold": {
    "description": "经过改良的「塑钢盔甲」。\n能够抵御使身体冻僵的寒意。\n可在「作业流水线工厂 II」制作。",
    "unlocks": [
      {
        "name": "耐寒塑钢盔甲",
  ...
  "Battle_RangeWeapon_GatlingGun": {
    "description": "可通过高速扫射实现压制战场的加特林机枪。\n压制射击能够将敌人射成蜂窝。\n可在「武器流水线工厂II」制作。",
    "unlocks": [
      {
        "name": "加特林机枪",
    ...
    "unlocks": [
      {
        ...
        "materials": [
          ...
          {
            "image": "https://cdn.paldb.cc/image/Others/InventoryItemIcon/Texture/T_itemicon_Food_Potion_High.webp",
            "name": "高品质恢复药",
            "amount": "5"
          },
          {
  ...
  "Battle_Armor_Grade_05_Plastic_Weight": {
    "description": "经过改良的「塑钢盔甲」。\n能增加玩家的负重上限。\n可在「作业流水线工厂 II」制作。",
    "unlocks": [
      {
        "name": "轻便塑钢盔甲",
  ...
  "Battle_RangeWeapon_GuidedMissileLauncher": {
    "description": "能够发射自动追踪敌人的导弹。\n导弹在命中后将爆炸，造成大范围伤害。\n可在「武器流水线工厂II」制作。",
    "unlocks": [
      {
        "name": "追踪导弹发射器",
  ...
  "FurnitureTree_Cherry": {
    "description": "装饰用的樱花树模型套组。\n配置一些树木，打造樱花岛风格的据点吧。\n拆除此建筑物无法取得材料。",
    "unlocks": [
      {
        "name": "仿真樱花树A",
    ...
    "unlocks": [
      {
        ...
        "description": "【ULTRAKILL 联动】\n参考遥远之地制造的维和机器人的结构打造的盔甲。\n舍弃自我修复功能，转而更进一步强化了装甲。耐寒Lv2",
        "materials": [
          {
            "image": "https://cdn.paldb.cc/image/Others/InventoryItemIcon/Texture/T_itemicon_Material_Plastic.webp",
            "name": "塑钢",
      ...
      {
        "name": "核心喷射霰弹枪",
        "image": "https://cdn.paldb.cc/image/Others/InventoryItemIcon/Texture/T_itemicon_Weapon_OctaviaShotgun.webp",
        "description": "【ULTRAKILL 联动】\n利用热能驱动可连续射击的霰弹枪。\n装备期间，投掷捕获用帕鲁球的动作将变为发射核心，长按可充能并延长核心发射的射程。\n被神射左轮手枪击中的核心将会爆炸。",
        "materials": [
          {
            "image": "https://cdn.paldb.cc/image/Others/InventoryItemIcon/Texture/T_itemicon_Material_StealIngot.webp",
            "name": "帕鲁金属锭",
  ...
  "StainlessSteel": {
    "description": "由铬铁矿和六棱晶矿加工制成的合金。\n是用于制作先进装备或建筑的材料。\n可在「巨大熔炉」冶炼。",
    "unlocks": [
      {
        "name": "六棱晶锭",
        "image": "https://cdn.paldb.cc/image/Others/InventoryItemIcon/Texture/T_itemicon_Material_StainlessSteel.webp",
        "description": "埋藏在地下的金属。\n可用金属探测器在部分岛屿上探测并挖掘出来。",
        "materials": []
      }
    ]
  },
    ...
    "unlocks": [
      {
        ...
        "materials": [
          {
            "image": "https://cdn.paldb.cc/image/Others/InventoryItemIcon/Texture/T_itemicon_Material_Chromium.webp",
            "name": "铬铁矿",
            "amount": "1"
          },
          {
  ...
  "MetalDetector": {
    "description": "使用后可探测隐藏在地下城中的铬铁矿，并标记其位置。\n一旦远离，标记就会消失。",
    "unlocks": [
      {
        "name": "金属探测器",
    ...
    "unlocks": [
      {
        ...
        "materials": [
          ...
          {
            "image": "https://cdn.paldb.cc/image/Others/InventoryItemIcon/Texture/T_itemicon_Food_Sweet.webp",
            "name": "棉花糖",
            "amount": "7"
          },
          {
  ...
  "Accessory_AirDash2": {
    "description": "装备后可使玩家获得空中二段冲刺能力的饰品。",
    "unlocks": [
      {
        "name": "空中二段冲刺靴",
        "image": "https://cdn.paldb.cc/image/Others/InventoryItemIcon/Texture/T_itemicon_Accessory_AirDash.webp",
        "description": "装备后可使玩家获得空中二段冲刺能力的饰品。空中冲刺+2",
        "materials": [
          {
            "image": "https://cdn.paldb.cc/image/Others/InventoryItemIcon/Texture/T_itemicon_Material_Plastic.webp",
            "name": "塑钢",
    ...
    "unlocks": [
      {
        ...
        "description": "只能在天坠之地发现的珍贵结晶。\n帕鲁矿历经漫长岁月凝结变质而成，\n呈现出彩虹般的光芒。",
        "materials": []
      }
    ]
  },
  "EnergyShotgun": {
    "description": "可以发射能量弹的霰弹枪。\n拥有优秀的连射性能，近距离火力异常强劲。",
    "unlocks": [
      {
        "name": "能量霰弹枪",
  ...
  "PalDopingShot_2": {
    "description": "向伙伴帕鲁射击可强化该帕鲁的攻击力与防御力，\n向敌人射击则会造成伤害。经过改良后，\n强化效果、持续时间及对敌伤害均有所提升。",
    "unlocks": [
      {
        "name": "高级强化枪",
  ...
  "OverheatRifle": {
    "description": "无需重复装弹即可实现连续射击的突击步枪。\n但长时间连射容易引发过热，\n导致出现巨大破绽，请务必注意。",
    "unlocks": [
      {
        "name": "过热步枪",
  ...
  "Accessory_AirDash3": {
    "description": "装备后可使玩家获得空中三段冲刺能力的饰品。",
    "unlocks": [
      {
        "name": "空中三段冲刺靴",
        "image": "https://cdn.paldb.cc/image/Others/InventoryItemIcon/Texture/T_itemicon_Accessory_AirDash.webp",
        "description": "装备后可使玩家获得空中三段冲刺能力的饰品。空中冲刺+3",
        "materials": [
          {
            "image": "https://cdn.paldb.cc/image/Others/InventoryItemIcon/Texture/T_itemicon_Material_ManganeseIngot.webp",
            "name": "珊瑚锭",
  ...
  "SkyislandIngot": {
    "description": "从沉睡在天阳乡的矿石中提取出的古代文明金属材料。\n是打造高级装备和建筑物时不可或缺的罕见加工素材。\n可在「古代文明炉」冶炼。",
    "unlocks": [
      {
        "name": "烈阳金属锭",
  ...
  "SkyBow": {
    "description": "用烈阳金属锭打造的弓。\n射击初速和贯通力得到大幅提升，可实现高精度远程射击。",
    "unlocks": [
      {
        "name": "机械弓",
  ...
  "Ancient_Houseset": {
    "description": "解锁此套组即可用古代文明建筑建造据点。\n可以建造的有地基、墙壁、屋顶和楼梯等\n建造房屋时所需的构造。",
    "unlocks": [
      {
        "name": "古代文明地基",
  ...
  "AncientArmor": {
    "description": "用烈阳金属锭打造的古代铠甲。\n失落文明的精髓毫无保留地注入其中，具备压倒性的防御力。\n即使是导致世界末日的威胁，也能坦然面对的究极防具。",
    "unlocks": [
      {
        "name": "远古盔甲",
  ...
  "AncientHelmet": {
    "description": "用烈阳金属锭打造的古代头盔。\n其中凝聚着历经岁月锤炼的智慧，能为穿戴者提供坚不可摧的保护。\n防御能力远远凌驾于现代的装备。",
    "unlocks": [
      {
        "name": "远古头盔",
  ...
  "SkyShotgun": {
    "description": "用烈阳金属锭制造的霰弹枪。\n极近距离下能发挥出霸道的火力，特殊的弹匣还增强了其持久作战能力。",
    "unlocks": [
      {
        "name": "原型霰弹枪",
  ...
  "SkyAssaultRifle": {
    "description": "用烈阳金属锭制造的突击步枪。\n在维持泛用性的前提下，能够装填威力更大的弹药。",
    "unlocks": [
      {
        "name": "重型突击步枪",
  ...
  "Accessory_JumpCount_Increase2": {
    "description": "装备后可使玩家获得三段跳跃能力的饰品。",
    "unlocks": [
      {
        "name": "三段跳靴",
        "image": "https://cdn.paldb.cc/image/Others/InventoryItemIcon/Texture/T_itemicon_Accessory_JumpCount_Increase.webp",
        "description": "装备后可使玩家获得三段跳跃能力的饰品。连续跳跃次数+2",
        "materials": [
          {
            "image": "https://cdn.paldb.cc/image/Others/InventoryItemIcon/Texture/T_itemicon_Material_StainlessSteel.webp",
            "name": "六棱晶锭",
  ...
  "Shield_07": {
    "description": "以失传的古代文明技术打造的神奇护盾。\n只要一段时间没受到攻击，就会自我修复。\n其性能之高，普遍认为就算是现代技术也无法重现。",
    "unlocks": [
      {
        "name": "远古护盾",
    ...
    "unlocks": [
      {
        ...
        "description": "只有在天阳乡才能开采到的稀有矿石。\n密度极高的母岩有着神秘的花纹，其中蕴含着光辉。",
        "materials": []
      }
    ]
  },
  "SkyBeamSword": {
    "description": "用烈阳金属锭制造的光剑。\n高能量光刃能够瞬间将面前的对手一刀两断。",
    "unlocks": [
      {
        "name": "高出力光剑",
  ...
  "SkillUnlock_SnowTigerBeastman": {
    ...
    "unlocks": [
      {
        "name": "霜牙王的巨锤",
        "image": "https://cdn.paldb.cc/image/Others/InventoryItemIcon/Texture/T_itemicon_Essential_SkillUnlock_Hammer.webp",
        "description": "持有此道具时，\n即可骑乘霜牙王。",
        "materials": [
          {
            "image": "https://cdn.paldb.cc/image/Others/InventoryItemIcon/Texture/T_itemicon_Material_SkyislandIngot.webp",
  ...
  "WorldTreeIngot": {
    "description": "烈阳金属和帕鲁树晶矿熔炼而成的至高合金。\n是古代文明技术和世界树之力的结晶，极其珍贵。\n想将最高级的装备和建筑物化为实体时不可或缺。",
    "unlocks": [
      {
        "name": "帕鲁树晶锭",
  ...
  "WidePenetrateShotgun": {
    "description": "强化了近战性能的光束武器。能将压缩的能量以扩散光束的形式发射出去。",
    "unlocks": [
      {
        "name": "散射光束枪",
    ...
    "unlocks": [
      {
        ...
        "materials": [
          {
            "image": "https://cdn.paldb.cc/image/Others/InventoryItemIcon/Texture/T_itemicon_Material_UniqueMaterial_FlowerPrince.webp",
            "name": "腐毒过滤膜",
            "amount": "10"
          },
          {
            "image": "https://cdn.paldb.cc/image/Others/InventoryItemIcon/Texture/T_itemicon_Material_WorldTreeOre.webp",
            "name": "帕鲁树晶矿",
            "amount": "30"
          }
        ]
    ...
    "unlocks": [
      {
        ...
        "materials": [
          {
            "image": "https://cdn.paldb.cc/image/Others/InventoryItemIcon/Texture/T_itemicon_Material_UniqueMaterial_Mothman.webp",
            "name": "防爆纤维",
            "amount": "10"
          },
          {
  ...
  "ElectricArcAssaultRifle": {
    "description": "着弹点会放出雷电的步枪，可连锁攻击多个敌人。",
    "unlocks": [
      {
        "name": "等离子步枪",
  ...
  "Supplement": {
    "description": "饮用后能在一段时间内抑制饥饿感的营养剂。\n浓缩了多种营养成分、风味浓郁，能防止在冒险途中感到饥饿。",
    "unlocks": [
      {
        "name": "营养剂",
        ...
        "materials": [
          ...
          {
            "image": "https://cdn.paldb.cc/image/Others/InventoryItemIcon/Texture/T_itemicon_Food_Sweet_Caramel.webp",
            "name": "焦糖棉花糖",
            "amount": "18"
          },
          {
  ...
  "BeamLauncher": {
    "description": "能发射高精度光束，引发大范围连锁爆炸的发射器。\n连射时要注意防止枪体过热。",
    "unlocks": [
      {
        "name": "光束炮发射器",
